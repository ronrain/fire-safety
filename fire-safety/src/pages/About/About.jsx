      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          ...
          <div className="mt-4">
              ...
              <img src="./smoke-de.webp" alt="Using WIFI enabled smoke detectors are the future of safety!" className="img-fluid" style={{ float:'left', maxWidth: '50%', height: 'auto', margin:'1rem' }} />
              <p>
          ...
          <img src="./shelter.jpeg" alt="NYC Shelters Need Trained Fire Guards" className="img-fluid" style={{ float:'right', maxWidth: '75%', height: 'auto', margin: '1rem' }} />
          <p>
